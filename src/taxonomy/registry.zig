...
pub const systems = [_]System{
    ...
    .{ .id = "ltl-bounded", .name = "Bounded Linear Temporal Logic", .family = .modal_temporal, .maturity = .fragment, .module = "ctl/ltl.zig", .notes = "LTL over finite traces: X/F/G/U/R; two-semantics (direct + SAT) cross-checked + exhaustive oracle; exhibit promotion = verified_exhibit" },
