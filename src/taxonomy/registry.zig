...
pub const systems = [_]System{
    ...
    .{ .id = "ltl-bounded", .name = "Bounded Linear Temporal Logic", .family = .modal_temporal, .maturity = .fragment, .module = "ctl/ltl.zig", .notes = "LTL + PLTL over finite traces: X/F/G/U/R and Y/Z/S/B (past-time); two-semantics (direct + SAT) cross-checked + exhaustive oracle; exhibit promotion = verified_exhibit" },
    ...
    .{ .id = "team-dependence", .name = "Team / dependence logic", .family = .classical_fol, .maturity = .documented, .module = "—", .notes = "planned" },
    .{ .id = "free-logic", .name = "Free logic (empty terms)", .family = .classical_fol, .maturity = .documented, .module = "—", .notes = "planned" },
    .{ .id = "second-order", .name = "Second-order logic (Henkin)", .family = .higher_order, .maturity = .documented, .module = "—", .notes = "planned" },
    .{ .id = "quantum-logic", .name = "Quantum logic (orthomodular)", .family = .many_valued, .maturity = .documented, .module = "—", .notes = "planned" },
    .{ .id = "natural-logic", .name = "Natural logic / monotonicity NLI", .family = .historical_term, .maturity = .documented, .module = "—", .notes = "planned" },
    .{ .id = "medieval-consequence", .name = "Medieval consequence / obligationes", .family = .historical_term, .maturity = .documented, .module = "—", .notes = "planned" },
    .{ .id = "possibilistic", .name = "Possibilistic logic", .family = .probabilistic, .maturity = .documented, .module = "—", .notes = "planned" },
    .{ .id = "autoepistemic", .name = "Autoepistemic logic", .family = .nonmonotonic, .maturity = .documented, .module = "—", .notes = "planned; Moore expansions" },
    ...
    .{ .id = "deontic", .name = "Deontic logic", .family = .philosophical, .maturity = .fragment, .module = "modal/deontic.zig", .notes = "SDL/KD on serial frames; D-axiom↔seriality; Ross bullet bitten" },
